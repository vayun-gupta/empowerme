...
KNOWLEDGE_BASE = [
    ...
    {
        "theme": "Confronting Bias and Discrimination in the Moment",
        "theories": "Make It Awkward framework (Isaac, 2025): conversation-closing responses to discriminatory comments designed to interrupt bias quickly and effectively without requiring justification or debate; Confrontation Effectiveness Research (Czopp, Monteith & Mark, 2006): confronting discriminatory comments reduces future bias in the perpetrator and signals norms to bystanders; Deliberate Practice Model (Lamb et al., 2009): confronting bias is a skill improved with low-stakes rehearsal before high-stakes situations; Speak Up Research (Swim & Hyers, 1999): fewer than 50% of people actually confront prejudice in the moment despite intending to — preparation and practice close this gap",
        "strategies": "Interrupt early — culture is determined by what is allowed to occur; speaking up early and consistently builds more inclusive environments. Use conversation-closing responses rather than logical debate — attempting to correct or prove the prejudiced person wrong is typically ineffective and escalates the situation. Describe the behaviour, not the label — say what was problematic about what was said without labelling the person as racist, sexist, or biased. Avoid punishment or demeaning — the goal is to set a norm, not to humiliate; respect for the other person's dignity is maintained while firmly addressing the comment. Respond quickly and briefly — hesitation allows the moment to pass; short, confident responses are more effective than lengthy explanations. Frame as norm-setting — position your response as upholding shared professional or institutional standards rather than a personal attack. Approach from curiosity when appropriate — asking 'what did you mean by that?' forces the speaker to examine their own statement without direct accusation.",
        "examples": "What did you mean by that? | That comment was not appropriate — I want to name the behaviour, not make this about you personally.",
        "when_effective": "When delivered quickly and briefly — short, confident responses outperform lengthy explanations. Confrontation generates spillover: reduces future bias in the perpetrator and signals to bystanders that discrimination is unacceptable (Czopp et al., 2006; Gervais et al., 2010). Preparation and rehearsal significantly increase follow-through — confronting bias is a skill that improves with deliberate practice.",
        "when_risky": "Logical explanations and defences invite counter-argument and signal that the comment is open for debate — avoid them. Labelling the person rather than the behaviour triggers defensiveness and closes down the interaction. Waiting for the right moment typically means the moment passes — earlier is almost always better. Source: Isaac, S. (2025). Be Ready to Make It Awkward — a participatory workshop to practise strategies for responding to discriminatory comments. https://doi.org/10.5281/zenodo.15029614. Referenced: Czopp, Monteith & Mark (2006); Gervais, Hillard & Vescio (2010); Swim & Hyers (1999); Lamb, Bigler, Liben & Green (2009).",
    },
]
